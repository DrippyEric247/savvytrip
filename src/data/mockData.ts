/** Seed data for mock adapters — types live in domain/travel.ts */
export type {
  RouteMode,
  RouteLeg,
  RouteOption,
...
import type { RouteMode, RouteOption, FeedItem, SavedTrip, TrendingSpot, AIRecommendation } from '../domain/travel'

/** Legacy seed shape for deals — mock adapter converts expires → expiresAt. */
...
export type SeedSavedTrip = Pick<SavedTrip, 'id' | 'name' | 'dates' | 'status'>
...
export const liveDeals: SeedDeal[] = [
  { id: 'd1', destination: 'Tokyo · Haneda cluster', discount: '−11%', expires: '42:18', modes: ['flight', 'hotel'] },
  { id: 'd2', destination: 'Barcelona · spring shoulder', discount: '−8%', expires: '19:02', modes: ['flight', 'train', 'hotel'] },
  { id: 'd3', destination: 'Chicago loop · events week', discount: '−15%', expires: '03:55', modes: ['rideshare', 'hotel'] },
]

export const savedTrips: SeedSavedTrip[] = [
...
export const aiRecommendations: AIRecommendation[] = [
  { id: 'a1', headline: 'Shift departure by 50 minutes', body: 'A slightly later train unlocks a cheaper ORD leg with the same hotel night — net −$31, +25m travel.', confidence: 0.91, cta: 'Preview remix' },
  { id: 'a2', headline: 'Bundle rideshare at ORD', body: 'Airport surge is cooling; locking a comfort ride now beats last-mile surge 73% of the time.', confidence: 0.84, cta: 'Simulate pickup' },
  { id: 'a3', headline: 'Hotel swap on night 2', body: 'Same star class two blocks away drops the stay $44 with negligible added walk time.', confidence: 0.88, cta: 'See on map' },
]
